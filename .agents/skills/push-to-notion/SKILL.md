---
name: push-to-notion
description: Create or update Notion knowledge records from the current working context. Use when saving a prompt, meeting note, project brief, architecture note, decision, or reference summary to Notion.
---

# Push to Notion

Save durable context into the Notion knowledge layer without making chat history the source of truth.
...
- Do not treat Notion as overriding GitHub, AGENTS.md, OpenSpec, CI policy, security controls, or source code.
